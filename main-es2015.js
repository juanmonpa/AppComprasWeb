...
let InisesComponent = class InisesComponent {
...
InisesComponent.ctorParameters = () => [
...
let AddpresComponent = class AddpresComponent {
    constructor(pf, presupuestoService) {
        this.pf = pf;
...
AddpresComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
...
let EditpresComponent = class EditpresComponent {
...
EditpresComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _servicios_presupuestos_service__WEBPACK_IMPORTED_MODULE_3__["PresupuestosService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"] }
...
let PresupuestosComponent = class PresupuestosComponent {
    constructor(presupuestosService) {
...
PresupuestosComponent.ctorParameters = () => [
...
let AddproveeComponent = class AddproveeComponent {
    constructor(pf, proveedorService) {
        this.pf = pf;
...
AddproveeComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
...
let EditproveeComponent = class EditproveeComponent {
...
EditproveeComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
...
ProveedoresComponent.ctorParameters = () => [
...
let AutenticacionService = class AutenticacionService {
    ...
    isAuthenticated() {
        const user = firebase__WEBPACK_IMPORTED_MODULE_3__["auth"]().currentUser;
        if (user) {
            return true;
        }
        else {
...
PresupuestosService.ctorParameters = () => [
...
ProveedoresService.ctorParameters = () => [
...
module.exports = __webpack_require__(/*! D:\PMD\angular\appCompras\src\main.ts */"./src/main.ts");
